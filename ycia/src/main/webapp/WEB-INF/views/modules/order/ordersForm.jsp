...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/order/orders/form?id=${orders.id}">订单管理<shiro:hasPermission name="order:orders:edit">${not empty orders.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="order:orders:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
