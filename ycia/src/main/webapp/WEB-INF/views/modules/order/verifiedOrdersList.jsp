...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/order/orders/verifiedlist">已审核订单</a></li>
		<li><a href="${ctx}/order/orders/verifylist">待审核订单</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="orders" action="${ctx}/order/orders/verifiedlist" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="orders">
			<tr>
				...
				<td><a href="${ctx}/order/orders/verifiedOrdersDetail?id=${orders.id}">查看详情</a></td>
			</tr>
		</c:forEach>
		</tbody>
	</table>
