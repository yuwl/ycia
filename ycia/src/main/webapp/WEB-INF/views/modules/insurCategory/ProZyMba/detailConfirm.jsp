...
<body>
<form:form id="inputForm" modelAttribute="offerDto" action="${ctx}/order/orderCompany/detail" method="post" class="form-horizontal">
	...
	<div class="control-group">
		...
		<div class="controls">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!-- <input type="text" name="insureName" class="required"/> -->
			<form:input path="premium" htmlEscape="false" maxlength="6" class="required" readonly="true"/>
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">手续费(%)</label>
		<div class="controls"><!-- <input type="text" name="insureName" class="required"/> -->
			<form:input path="feeRate" htmlEscape="false" maxlength="6" class="required" readonly="true"/>
		</div>
	</div>
	<div class="control-group">
		...
		<div class="controls"><!-- <input type="text" name="insureName" class="required"/> -->
			<form:input path="deductible" htmlEscape="false" maxlength="6" class="required" readonly="true"/>
		</div>
	</div>
		<div class="control-group">
		<label class="control-label">免赔细则</label> 
		<div class="controls"><!-- <textarea cols="500" rows="5" name="insureName" class="required"></textarea> -->
			<form:textarea path="deductibleDesc" htmlEscape="false" maxlength="500" class="required" readonly="true"/>
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">盖章凭证:</label>
		<div class="controls">
			<input type="hidden" name="orderCompanyId" value="${offerDto.orderCompanyId}" />
			<input type="hidden" name="companyId" value="${offerDto.companyId}" />
			<c:if test="${offerDto.sealCret!=''}">
				<img src="${offerDto.sealCret}" width="300" height="300">
			</c:if>
		</div>
	</div>
	<div class="control-group">
		...
		<div class="controls">
			<c:if test="${offerDto.payCret!=''}">
				<img src="${offerDto.payCret}" width="300" height="300">
			</c:if>
		</div>
	</div>
	<div class="form-actions">
		<input id="pass" class="btn btn-primary" type="button" value="审核通过" />
...
<script type="text/javascript">
		...
		$("#pass").bind("click",function(){
			var orderCompanyId = $("input[name='orderCompanyId']").val();
			var companyId = $("input[name='companyId']").val();
			var orderNo = $("#orderNo").val();
			window.location = "${ctx}/order/orderCompany/updateStatus?orderCompanyId="+orderCompanyId+"&companyId="+companyId+"&orderNo="+orderNo;
        });
