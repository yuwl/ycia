...
<div class="control-group">
	...
	<div class="controls">
		<form:input path="proZyMba.startTime" htmlEscape="false" maxlength="50" class="required"/>-
		<form:input path="proZyMba.endTime" htmlEscape="false" maxlength="50" class="required"/>
		<span class="help-inline"><font color="red">*</font> </span>
	</div>
</div>
<div class="control-group">
	...
	<div class="controls">
		<form:select path="proZyMba.totalClaim" style="width: 250px;">
            <option selected value="50万">50万</option>
...
<div class="control-group">
	...
	<div class="controls">
		<form:input path="proZyMba.eachClaim" htmlEscape="false" maxlength="50" class="required"/>
		<span class="help-inline"><font color="red">*</font> </span>
	</div>
</div>
